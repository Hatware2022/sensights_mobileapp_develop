...
import { Text, SafeAreaView, View, Image, TouchableOpacity, ScrollView, StyleSheet, Platform, } from "react-native"
...
export default class VayyarConnect extends Component {
constructor(props){
    super();
    const { navigation } = props.navigation
    this.state = {
        deviceName : "Home Monitoring",
        deviceModel: "Vayyar Walabot Home",
        deviceImage: images.vayyar,
    }
}
                            ...
                            <WebView 
                                ...
                                source={{ 
                                    html: `
                                                ...
                                                <div>
                                                <iframe width="560" height="315" src="https://www.youtube.com/embed/C-KXuKM5b3o" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> 
                                        </div> `
