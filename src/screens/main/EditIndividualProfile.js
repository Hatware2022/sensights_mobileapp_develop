import {
  ...
  export class EditIndividualProfile extends Component {
    state = {
      fatalError: null,
  ...
  // 
    ...
    render() {
      console.log("this.state: ",this.isPrimary);
      ...
      return (
        <View style={styles.root}>
          ...
          <NavigationHeaderV2 //allowBack backText={'Cancel'}
            ...
            buttonLeft={{onPress: this.canceIndividuallButtonPress, text: 'Cancel'}}
            buttonRight={{onPress:this.individual? null:this.updateIndividualProfile ,  text:this.individual ?  '' :'Done' }}
            ...
            <KeyboardAwareScrollView
              ...
              <View style={styles.container}>
                <View
                  ...
                  <View>
                    <TouchableOpacity
                       disabled={this.individual ? true:false}
                  ...
                  <View style={{flex: 1}}>
                    <TextInput
                    editable={this.individual ? false:true}
                      value={firstName}
