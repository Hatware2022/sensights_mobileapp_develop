...
export const HeartRateVariationScreen = (props) => {
  const d = new Date();
  ...
  const renderList = (list) => {
    return list.length > 0 ? (
      <>
        <Text style={styles.heading}>DAILY AVERAGE</Text>
        <ScrollView
          refreshControl={
    ...
    <View style={{ flex: 1 }}>
      ...
      <LinearGradient colors={["#0152A9", "#007AFF"]}>
        ...
        >
          ...
          >
            Heart Rate Variability for Last Week
          </Text>
        </View>
      </LinearGradient>
...
HeartRateVariationScreen.navigationOptions = ({ navigation }) => {
